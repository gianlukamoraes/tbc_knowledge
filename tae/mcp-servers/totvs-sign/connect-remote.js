...
const REMOTE_URL = 'https://mcp.totvstbc.com.br/totvssign';
  ...
  const diagnosticInfo = {
    ...
    fix: !emailUsed
      ? [
          ...
          '1. export TAE_USER_EMAIL=seu@email.com TAE_PASSWORD=sua-senha',
      ...
      : errorMessage.includes('denied') || errorMessage.includes('not authorized')
        ? `Email "${emailUsed}" não autorizado. Entre em contato com o suporte TBC.`
