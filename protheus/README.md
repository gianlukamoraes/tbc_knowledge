...
- Node.js 18+
- Email corporativo com acesso ao TBC Knowledge
...
> O email precisa ter acesso ao TBC Knowledge. Entre em contato com o suporte TBC para provisionar acesso.
...
```bash
claude plugin update protheus@tbc_knowledge
```
